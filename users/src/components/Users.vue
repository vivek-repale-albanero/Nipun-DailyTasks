<template>
  <div class="main-container">
    <button @click="togglePopup()" id="btn-add-user" class="btn btn-success">Add User <i class="fas fa-user-plus"></i></button>
  ...
  <tbody>
    ...
    <tr v-for="(user, index) in users" :key="index">
      ...
      <td><button @click="editUser(index)" class="btn btn-warning btn-edit">Edit</button></td>
